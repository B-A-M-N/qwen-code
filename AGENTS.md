...
This project is indexed by GitNexus as **qwen-code** (49052 symbols, 80774 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
